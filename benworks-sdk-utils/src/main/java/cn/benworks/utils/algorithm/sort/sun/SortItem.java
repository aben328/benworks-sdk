package cn.benworks.utils.algorithm.sort.sun;

/* @(#)SortItem.java 1.17f 95/04/10 James Gosling 1.18 96/4/24 Jim Hagen : use setBackground
 * 
...
/**
 * A simple applet class to demonstrate a sort algorithm. You can specify a sorting algorithm using the "alg" attribute.
 * When you click on the applet, a thread is forked which animates the sorting algorithm. You can also specify the
 * length of the pause with the "pause" attribute. Default is 200.
