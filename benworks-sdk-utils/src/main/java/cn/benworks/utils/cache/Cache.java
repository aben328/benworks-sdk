 ...
 * agreement with Jive.
 */
package cn.benworks.utils.cache;

/**
 * General purpose cache. It stores objects associated with unique keys in
 * memory for fast access. All keys and values added to the cache must implement
 * the Serializable interface. Values may implement the Cacheable interface,
 * which allows the cache to determine object size much more quickly. These
 * restrictions allow a cache to never grow larger than a specified number of
 * bytes and to optionally be distributed over a cluster of servers.
 * <p>
 * 
 ...
 * object will remain in cache after it is put in.
 * <p>
 * 
